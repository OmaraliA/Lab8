...
namespace Example2.Model
{
    ...
    public class Drawer //класс
    {
        ...
        public Drawer(PictureBox pictureBox1)
        {
        ...
        public void Draw(Point currentPoint) //method risovania
        {
            ...
            switch (Shape)
            {
                ...
                case Shape.Triangle:
                    ...
                    triangle[0] = new PointF((prevPoint.X + currentPoint.X) / 2, prevPoint.Y);

                    triangle[1] = new PointF(prevPoint.X, currentPoint.Y);
                    triangle[2] = new PointF(currentPoint.X, currentPoint.Y);
